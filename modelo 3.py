...
print(df.head())
modelo1=BayesianNetwork([  ("AF", "Target"),("Q", "Target"),("B", "Target"),("T", "Target"),("P", "Target"), ("D","Z"),("D","AF"),("Z","AF"),("R","AF"),("R","Z"),("G","AF"),("G","Z"),("T","AF"),("T","Z"),("S","AF"),("S","Z"),("W","Y"),("Y","Z"),("AC","AE"),("AE","AF")])
X = df[["Z","Target","AF","D","R","G","T","S","W","Y","AC","AE","Q","B","P"]]
...
cpd_B = estimador_bayesiano.estimate_cpd('B')

# Añadir las CPDs estimadas al modelo
modelo1.add_cpds(cpd_Z, cpd_Target, cpd_AF, cpd_D, cpd_R, cpd_G, cpd_T, cpd_S, cpd_W,cpd_Y,cpd_AC,cpd_AE,cpd_P,cpd_Q,cpd_B)
...
for index, row in X_test.iterrows():  
    ...
    result= infer.query(["Target"], evidence={"Z": Z_value, "AF": AF_value, "D": D_value, "R": R_value, "G": G_value, "T": T_value, "S": S_value,
                                              "W":W_value,"Y":Y_value,"AC":AC_value,"AE":AE_value,"Q":Q_value,"B":B_value,"P":P_value})
